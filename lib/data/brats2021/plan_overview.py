...
def main(
    preprocessed_data_path: Union[Path, str] = Path('/mnt/workspace/jfacuse/prostate/workdir/nnUNet_raw_data/Dataset137_BraTS2021'),
    overviews_path: Union[Path, str] = Path('/mnt/workspace/jfacuse/prostate/workdir/results/UNet/overviews/Task137_Brats2021'),
        ...
        for split, nnunet_split in nnunet_fold.items():
            ...
            for subject_id in nnunet_split:
                ...
                overview['image_paths'] += [[
                    ...
                    str((preprocessed_data_path / 'imagesTr' / f'{subject_id}_0003.nii.gz').as_posix()),
                ]]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--task", type=str, default="Task137_Brats2021",
