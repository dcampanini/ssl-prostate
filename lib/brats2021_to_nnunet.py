...
nnUNet_raw = '/mnt/workspace/jfacuse/prostate/workdir/nnUNet_raw_data'
lbl_file_path = '/home/jfacuse/brats_pos_cases.txt'


def copy_BraTS_segmentation_and_convert_labels_to_nnUNet(in_file: str, out_file: str, labels_file = lbl_file_path) -> None:
    ...
    if np.max(seg_new) > 0:
        with open(lbl_file_path, 'a') as f:
            f.write(out_file.split('/')[-1]+'\n')
...
if __name__ == '__main__':
    brats_data_dir = '/mnt/data/Brats2021'
